        ...
        <div class="informationArea">
            ...
            <div class="headAreaOfUser">
                <div style="height:50px;width: 50px;border-radius: 10px;overflow: hidden">
                    <el-upload :action="avatarPostUrl" :show-file-list="false" :on-success="handleAvatarSuccess"
                        class="avatar-uploader" name="picture">
            ...
            <transition-group name="list-complete" tag="p" appear>
                ...
                <div v-show="flagOfPersonalData" class="personalDataArea" :key="2">
                    ...
                    <div class="headOfPersonData">
                        ...
                        <span style="flex: 1">
                            <el-button v-show="flagOfChangeUserData" type="primary" round
                                style="margin-right: 20px;background-color: rgba(255,255,255,0.1);color: #589D95;font-weight: bold;border: 1px solid #257B5E;height: 25px"
                    ...
                    <div class="mainBodyOfPersonalData">
                        ...
                        <div v-show="!flagOfChangeUserData" class="defaultInformation"
                            @click="flagOfChangeUserData = !flagOfChangeUserData">
                            <div>
                                姓名:
                        ...
                        <!--                    修改信息-->
                        <el-form v-show="flagOfChangeUserData" class="changeDataOfUser" ref="form" :model="userData"
                            label-width="80px">
                            ...
                            <el-form-item label="年龄:" prop="age"
                                ...
                                <el-input-number v-model="userData.age" placeholder="请输入年龄"
                                    style="width: 140px"></el-input-number>
                            </el-form-item>
                            <el-form-item label="性别:" prop="gender"
                                :rules="{ required: true, message: '请选择性别', trigger: 'change' }">
                                <el-select v-model="userData.gender" placeholder="请选择性别" style="width: 140px">
                            ...
                            <el-form-item label="体重:" prop="weight"
                                ...
                                <el-input-number v-model="userData.weight" placeholder="请输入体重"
                                    style="width: 140px"></el-input-number>
                            </el-form-item>
                            <el-form-item label="身高:" prop="height"
                                :rules="{ required: true, message: '请输入身高', trigger: 'blur' }">
                                <el-input-number v-model="userData.height" placeholder="请输入身高"
                                    style="width: 140px"></el-input-number>
                            </el-form-item>
                            <el-form-item label="血型:" prop="blood_type"
                                :rules="{ required: true, message: '请输入血型', trigger: 'blur' }">
                                <el-input v-model="userData.blood_type" placeholder="请输入血型"
            ...
            this.request.get("info/" + this.user.id)
                .then(res => {
                    ...
                    if (res.status == "200") {
                        ...
                        this.userData.picture = this.userData.picture != "" ? this.userData.picture : "https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png"
